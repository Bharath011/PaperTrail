...
export default function WeeklyFocus({ papers, onOpen, onStatus, onRemove, onChoose, readOnly = false }: Props) {
  return <section className="weekly-focus">
    <div className="focus-heading">
      ...
      <div className="focus-heading-actions"><button className="primary" onClick={onChoose}><span aria-hidden="true">+</span> Add papers</button></div>
    </div>
